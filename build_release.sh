...
tar -Jcvf brain_1.0_linux_arm64.tar.xz brain brain.service brain.yaml setup.sh uninstall.sh &>/dev/null && echo "Successfully build brain <linux arm64>"
mv brain_1.0_linux_arm64.tar.xz ../dist/

GOOS=linux GOARCH=386 CGO_ENABLED=0 go build -o brain .
tar -Jcvf brain_1.0_linux_i386.tar.xz brain brain.service brain.yaml setup.sh uninstall.sh &>/dev/null && echo "Successfully build brain <linux i386>"
mv brain_1.0_linux_i386.tar.xz ../dist/

GOOS=linux GOARCH=mips CGO_ENABLED=0 go build -o brain .
tar -Jcvf brain_1.0_linux_mips.tar.xz brain brain.service brain.yaml setup.sh uninstall.sh &>/dev/null && echo "Successfully build brain <linux mips>"
mv brain_1.0_linux_mips.tar.xz ../dist/
...
tar -Jcvf tentacle_1.0_linux_arm64.tar.xz tentacle tentacle.service tentacle.yaml setup.sh uninstall.sh &>/dev/null && echo "Successfully build tentacle <linux arm64>"
mv tentacle_1.0_linux_arm64.tar.xz ../dist/

GOOS=linux GOARCH=386 CGO_ENABLED=0 go build -o tentacle .
tar -Jcvf tentacle_1.0_linux_i386.tar.xz tentacle tentacle.service tentacle.yaml setup.sh uninstall.sh &>/dev/null && echo "Successfully build tentacle <linux i386>"
mv tentacle_1.0_linux_i386.tar.xz ../dist/

GOOS=linux GOARCH=mips CGO_ENABLED=0 go build -o tentacle .
tar -Jcvf tentacle_1.0_linux_mips.tar.xz tentacle tentacle.service tentacle.yaml setup.sh uninstall.sh &>/dev/null && echo "Successfully build tentacle <linux mips>"
mv tentacle_1.0_linux_mips.tar.xz ../dist/
