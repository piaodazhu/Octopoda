...
Upgrade:pakma:octl pakma [state|install <version>|upgrade <version>|confirm|cancel|owngrade|history] [<master>|<node1>|<node2>|...] [-t<timestr>] [-l<limit>]:octl pakma uprate 1.5.1 master pi0 pi1 pi2
`
